...
CREATE TABLE song_producer_relation(
  id SERIAL PRIMARY KEY,
  producer_id INT NOT NULL REFERENCES producers ON DELETE CASCADE,
  song_id INT NOT NULL REFERENCES songs ON DELETE CASCADE
);
...
VALUES
  ...
  VALUES
    ('Dust Brothers'),('Stephen Lironi'),('Roy Thomas Baker'),('Walter Afanasieff'),('Benjamin Rice'),('Rick Parashar'),('Al Shux'),
    ('Max Martin'),('Cirkut'),('Shellback'),('Benny Blanco'),('The Matrix'), ('Darkchild');
...
INSERT INTO song_artist_relation(song_id,artist_id)
VALUES
  (1,1),
  (2,2),
  (3,3),(3,4),
  ...
  (9,14),
  (10,15);
INSERT INTO song_producer_relation(song_id,producer_id)
VALUES
  (1,1),(1,2),
  (2,3),
  (3,4),
